...
generatefolder(f"./Adversarial_Attack_Test/{choose_dataset}/FGSM_Attack/", today)
save_dir = f"./Adversarial_Attack_Test/{choose_dataset}/FGSM_Attack/{today}"
...
def FGSM_attack_evaluation(model, DEVICE, test_loader, classifier, attack, save_dir, epsilon,bool_genrate_Train_Or_Test):

...
# CICIDS2017_and_CICIDS2018_test 123 feature test
generatefolder(filepath + "\\dataset_AfterProcessed\\CICIDS2017_and_CICIDS2018_test\\", today)
...
# CICIDS2017_and_CICIDS2018_TONIOT_test 123 feature test
...
# CICIDS2017_and_CICIDS2018_test 123 feature test
np.save(f"./data/dataset_AfterProcessed/CICIDS2017_and_CICIDS2018_test/{today}/merged_x_Non_IID_ALL_test.npy", merged_x)
np.save(f"./data/dataset_AfterProcessed/CICIDS2017_and_CICIDS2018_test/{today}/merged_y_Non_IID_ALL_test.npy", merged_y)
...
# CICIDS2017_and_CICIDS2018 123 feature test
merged_df.to_csv(f"./data/dataset_AfterProcessed/CICIDS2017_and_CICIDS2018_test/{today}/CICIDS2017_and_CICIDS2018_test_merged.csv", index=False)

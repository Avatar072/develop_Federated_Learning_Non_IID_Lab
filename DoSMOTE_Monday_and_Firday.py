...
######################## Choose Dataset ##############################
# 根據參數選擇dataset
# python DoSMOTE_Monday_and_Firday.py --dataset train_half1
# python DoSMOTE_Monday_and_Firday.py --dataset total_train
# python DoSMOTE_Monday_and_Firday.py --dataset train_half1 --epochs 10000 --weaklabel 13
# python DoSMOTE_Monday_and_Firday.py --dataset train_half1 --method normal
...
sampling_strategy_Label_Bot  = {1: 2348}
sampling_strategy_Label_DDoS    = {2: 12000} 
sampling_strategy_Label_PortScan  = {10: 12000}
...
def DoALLWeakLabel(x_train,y_train, ChooseLabel, bool_choose_default_k_neighbors,choose_merge_days):
    ...
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Label1")
    ...
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Monday_and_Firday_ALL_Label")
    ...
    if(bool_choose_default_k_neighbors):# k_neighbors  use default 5
        ...
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label_Bot, 5, X_res, y_res, 1,choose_merge_days)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label_DDoS, 5, X_res, y_res, 2,choose_merge_days)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label_PortScan, 5, X_res, y_res, 10,choose_merge_days)
        # y_res = y_res.astype(int) 
        # spilttrainhalfAfterSMOTE(X_res,y_res)
    else: 
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label_BENIGN, 2, x_train, y_train, 0,choose_merge_days)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label_Bot, 5, X_res, y_res, 1,choose_merge_days)
        X_res, y_res = SMOTEParameterSet(sampling_strategy_Label_DDoS,4, X_res, y_res, 2,choose_merge_days)
...
def DoBorederlineSMOTE(x_train, y_train,choosekind,ChooseLable,choose_merge_days):
    ...
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Label1")
    ...
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Monday_and_Firday_ALL_Label")
    ...
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label_Bot, choosekind, 5, 10, X_res, y_res, 1,choose_merge_days)
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label_DDoS, choosekind, 5, 10, X_res, y_res, 2,choose_merge_days)
    X_res, y_res = BorderLineParameterSet(sampling_strategy_Label_PortScan, choosekind, 5, 10, X_res, y_res, 10,choose_merge_days)
    
    print('Afterr BorderLine SMOTE dataset shape %s' % Counter(y_res))
#    D:\develop_Federated_Learning_Non_IID_Lab\data\dataset_AfterProcessed\CICIDS2017\Monday_and_Firday\ALL_Label\BorderlineSMOTE\borderline-1\20240317\client2\Monday_and_Firday_ALL_Label
    np.save(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\Monday_and_Firday_ALL_Label\\x_{choosekind}_{today}.npy', X_res)
    np.save(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\Monday_and_Firday_ALL_Label\\y_{choosekind}_{today}.npy', y_res)
...
DoALLWeakLabel(x_train,y_train,"Monday_and_Firday_ALL_Label", True,"Monday_and_Firday")
# DoALL_Label(x_train,y_train)
DoBorederlineSMOTE(x_train, y_train,"borderline-1","Monday_and_Firday_ALL_Label","Monday_and_Firday")
DoBorederlineSMOTE(x_train, y_train,"borderline-2","Monday_and_Firday_ALL_Label","Monday_and_Firday")

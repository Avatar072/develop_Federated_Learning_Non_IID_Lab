...
######################## Choose Dataset ##############################
# 根據參數選擇dataset
# python DoSMOTE_Tuesday_and_Wednesday_and_Thursday.py --dataset train_half2
# python DoSMOTE_Tuesday_and_Wednesday_and_Thursday.py --dataset total_train
# python DoSMOTE_Tuesday_and_Wednesday_and_Thursday.py --dataset train_half2 --epochs 10000 --weaklabel 13
# python DoSMOTE_Tuesday_and_Wednesday_and_Thursday.py --dataset train_half2 --method normal
...
def DoALLWeakLabel(x_train,y_train, ChooseLabel, bool_choose_default_k_neighbors,choose_merge_days):
    ...
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\SMOTE\\{today}\\{client_str}\\', "Tuesday_and_Wednesday_and_Thursday_ALL_Label")
...
def DoBorederlineSMOTE(x_train, y_train,choosekind,ChooseLable,choose_merge_days):
    ...
    generatefolder(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\', "Tuesday_and_Wednesday_and_Thursday_ALL_Label")
...
#    D:\develop_Federated_Learning_Non_IID_Lab\data\dataset_AfterProcessed\CICIDS2017\Tuesday_and_Wednesday_and_Thursday\ALL_Label\BorderlineSMOTE\borderline-1\20240317\client2\Tuesday_and_Wednesday_and_Thursday_ALL_Label
    np.save(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\Tuesday_and_Wednesday_and_Thursday_ALL_Label\\x_{choosekind}_{today}.npy', X_res)
    np.save(f'{filepath}\\dataset_AfterProcessed\\CICIDS2017\\{choose_merge_days}\\ALL_Label\\BorderlineSMOTE\\{choosekind}\\{today}\\{client_str}\\Tuesday_and_Wednesday_and_Thursday_ALL_Label\\y_{choosekind}_{today}.npy', y_res)
...
DoALLWeakLabel(x_train,y_train,"Tuesday_and_Wednesday_and_Thursday_ALL_Label", True,"Tuesday_and_Wednesday_and_Thursday")
# DoALL_Label(x_train,y_train)
DoBorederlineSMOTE(x_train, y_train,"borderline-1","Tuesday_and_Wednesday_and_Thursday_ALL_Label","Tuesday_and_Wednesday_and_Thursday")
DoBorederlineSMOTE(x_train, y_train,"borderline-2","Tuesday_and_Wednesday_and_Thursday_ALL_Label","Tuesday_and_Wednesday_and_Thursday")

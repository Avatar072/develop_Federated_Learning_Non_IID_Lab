...
def DoBaselinesplit(df,train_dataframes,test_dataframes):
    ...
    train_label_SQL_Injection, test_label_SQL_Injection = spiltweakLabelbalance(13,df,0.33)
    # # 刪除Label相當於15的行
...
def forBaseLineUseData(choose_merge_days,bool_Noniid):
    if choose_merge_days == "csv_data":
        ...
        # DoSpiltAllfeatureAfterMinMax(df_csv_data,choose_merge_days,bool_Noniid)
        # 做ChiSquare

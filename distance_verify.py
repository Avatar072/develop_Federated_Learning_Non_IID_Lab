...
# *k倍
df["Delta_K_2_*1"]=0.5*df["max_squared_difference"]*2+0.5*1
df["Delta_K_3_*1"]=0.5*df["max_squared_difference"]*3+0.5*1
df["Delta_K_4_*1"]=0.5*df["max_squared_difference"]*4+0.5*1
df["Delta_K_2_*2"]=0.5*df["max_squared_difference"]*2+0.5*2
df["Delta_K_3_*2"]=0.5*df["max_squared_difference"]*3+0.5*2
df["Delta_K_4_*2"]=0.5*df["max_squared_difference"]*4+0.5*2

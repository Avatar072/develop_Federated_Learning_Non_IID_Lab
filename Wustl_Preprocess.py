...
generatefolder(filepath + "\\dataset_AfterProcessed\\", "Wustl")
generatefolder(filepath + "\\dataset_AfterProcessed\\Wustl\\", today)

ResotreTrainAndTestToCSVandReSplit("Wustl",filepath)

def DoSpilthalfForiid(choose_merge_days):
    if choose_merge_days == "Wustl":
        df_ALLtrain = pd.read_csv(filepath + "\\dataset_AfterProcessed\\Wustl\\20240507\\Resplit_train_dataframes_20240507.csv")
